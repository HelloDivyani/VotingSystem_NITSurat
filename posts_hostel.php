                            ...
                            <div class="x_content">
							 ...
							 <table class="table table-bordered">
							   ...
							   <?php
								...
								{
								echo "<tr>";
								echo "<td>"; ?> <a href="candidate_display_hostel.php?id=<?php echo $row['id'] ?>&data=postshostel&post=<?php echo $row['Name']?>&hostel=<?php echo $hostel?>"> <?php echo $row['Name']?> </a> <?php  echo"</td>";
